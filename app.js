...
var incompleteTaskHolder=document.querySelector(".todo__list_added");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".todo__list_done");//completed-tasks
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.children[1].classList.add('todo__label_done');
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.children[1].classList.remove('todo__label_done');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
